...
const meta: Meta = {
  ...
  component: Collapse,
  subcomponents: { 'Collapse.Title': Collapse.Title, 'Collapse.Content': Collapse.Content },
  parameters: {
...
WithBorderAndBackgroundColor.args = {
  ...
  children: [
    ...
    <Collapse.Content>
      Notice that only clicking the title again will close, while focusing still opens it. Collapses
