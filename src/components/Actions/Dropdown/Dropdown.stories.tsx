  ...
  return (
    <div className="w-full flex flex-row items-center justify-center">
      <Dropdown end {...rest}>
        <Dropdown.Label>{label}</Dropdown.Label>
        <Dropdown.Content>
          <Card compact shadow="xl" className="w-64 p-2 bg-primary text-primary-content">
            <Card.Body>
...
const MenuIconButton = ({ isOpen, toggleOpen }: { isOpen?: boolean; toggleOpen?: () => void }) => {
  ...
  return (
    <div>
      ...
      <Dropdown end {...rest}>
        ...
        <Dropdown.Content>
          <Card compact shadow className="bg-base-100 w-64">
            <Card.Body>
